...
const Main = () => {
  ...
  useEffect(() => {
    const fetchIphoneData = async () => {
        try {
            const response = await axios.get('https://pos-vercel-server.vercel.app/home');
  ...
  useEffect(() => {
    const fetchAndroidData = async () => {
        try {
            const response = await axios.get('https://pos-vercel-server.vercel.app/android');
...
const handleCheckout = async () => {
  ...
  try {
    const response = await axios.post('https://pos-vercel-server.vercel.app/customer/checkout', { phoneNumber });
...
const handleCreateAccount = async (e) => {
  ...
  try {
    const response = await axios.post('https://pos-vercel-server.vercel.app/customer/create', {
      fullName,
      address,
...
const searchProductByBarcode = async () => {
  if (selectedBrand === 'APPLE') {
    try {
      const response = await axios.get(`https://pos-vercel-server.vercel.app/home/barcode/${barcode}`);
    ...
    try {
      const response = await axios.get(`https://pos-vercel-server.vercel.app/android/barcode/${barcode}`);
      setProduct(response.data);
      setError('');
    } catch (error) {
      setError('Không tìm thấy sản phẩm');
...
const payMention = async () => {
  try {
    const responseOrder = await axios.post('https://pos-vercel-server.vercel.app/order', {phoneNumber,total: orderTotalCost()});
