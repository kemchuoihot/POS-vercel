...
const Employee = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("https://pos-vercel-server.vercel.app/account",{name,email},{headers: {
    ...
    const blockEmployee = () => {
        axios.post('https://pos-vercel-server.vercel.app/auth/block_employee', {email: block})
        .then(result =>{
            if(result.data.Status){
                fetchData();
                setBlock("")
    ...
    const resend = (email) => {
        axios.post('https://pos-vercel-server.vercel.app/auth/newtoken', {email})
        .then(result =>{
            if(result.data.Status){
                fetchData();
            }else{
